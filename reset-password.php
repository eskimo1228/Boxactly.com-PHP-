                            ...
                            <div class="form-info">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
									...
									<div class="col-md-12">
                                        <div class="row">
                                            <div class="form-group">
                                                <input type="password" name="new_pass_c" class="form-control" placeholder="Confirm new password*" required="required">
                                    ...
                                    <div class="col-md-12" style="padding-top:16px;">
                                        <div class="row" style="text-align:center;">
                                            <button type="submit" name="new_password" class="login-btn">
                                                Change >>
                                            </button>
                                        </div>
                                    </div>
